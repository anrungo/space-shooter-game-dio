...
function createLaserElement() {
  ...
  let newLaser = document.createElement('images');
...
function createAliens() {
  let newAlien = document.createElement('images');
  let alienSprite = aliensImg[Math.floor(Math.random * aliensImg.length)]; //sorteio de imanges
...
//funcao para movimentar os nossos inimigos
